...
const PublicHeader = () => {
    ...
    return (
        <div>
            <MobileMenu handleToggle={handleToggle} toggle={toggle}></MobileMenu>
            <div className=" flex justify-between items-center px-20 xs:px-6 sm:px-10 py-3 border-b border-gray-300">
                ...
                <button onClick={handleToggle}><IoMenuSharp className="text-4xl text-black hidden xs:block sm:block" /></button>
